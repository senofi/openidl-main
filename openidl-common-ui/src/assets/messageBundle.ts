export const MESSAGE = {
    ...
    "PAGE_LEAVE_CONFIRMATION": {
        "message": "Are you sure you want to leave this page without submitting? Your information will be lost.",
        "type": "info",
        "title": ""
    },
    ...
    "DATACALL_FETCH_ERROR": {
        "type": "error",
        "message": "Could not fetch the datacall details due to some technical error.",
        "title": "Error"
    },

    "DATACALL_VERSION_FETCH_ERROR": {
        "type": "error",
        "message": "Could not fetch datacall versions due to some technical error.",
        "title": "Error"
    },
    ...
    "DELIVERY_DATE_UPDATE_FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update the delivery date due to some technical error."
    },
    "DRAFT_SAVE_FAIL": {
        "type": "error",
    ...
    "SET_EXTRACTION_FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update the extraction pattern due to some technical error."
    },

    "SET_ALLFIELDS_SUCCESS": {
        "type": "success",
        "title": "Success",
        "message": "Proposed delivery date, forum URL, and extraction pattern have been successfully updated."
    },

    "SET_ALLFIELDS_FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update proposed delivery date, forum URL, and extraction pattern due to some technical error."
    },

    "SET_PATTERN_FORUM_SUCCESS": {
        "type": "success",
        "title": "Success",
        "message": "Forum URL and extraction pattern have been successfully updated."
    },
    "SET_PATTERN_FORUM__FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update forum URL and extraction pattern due to some technical error."
    },

    "SET_PATTERN_DATE_SUCCESS": {
        "type": "success",
        "title": "Success",
        "message": "Proposed delivery date and extraction pattern have been successfully updated."
    },
    "SET_PATTERN_DATE__FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update proposed delivery date and extraction pattern due to some technical error."
    },
    "SET_FORUM_DATE_SUCCESS": {
        "type": "success",
        "title": "Success",
        "message": "Proposed delivery date and forum URL have been successfully updated."
    },

    "SET_FORUM_DATE__FAIL": {
        "type": "error",
        "title": "Error",
        "message": "Could not update proposed delivery date and forum URL due to some technical error."
    },
    ...
    "EXTRACTION_PATTERN_MESSAGE": {
        "message" : "Please note that this file is for informational purposes only. This file can't be used to run the data extraction."
    }
