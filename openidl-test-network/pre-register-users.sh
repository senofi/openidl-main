...
fabric-ca-client register --caname ca-aais --id.name openidl-transactional-data-event-listener-ibp-2.0 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/organizations/fabric-ca/aais/tls-cert.pem
...
fabric-ca-client register --caname ca-aais --id.name openidl-data-call-mood-listener-ibp-2.0 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/organizations/fabric-ca/aais/tls-cert.pem
